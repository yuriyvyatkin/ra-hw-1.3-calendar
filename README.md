# Домашнее задание №3 к лекции «Компоненты»

[![Build status](https://ci.appveyor.com/api/projects/status/kneb8m6xen3vae63?svg=true)](https://ci.appveyor.com/project/yuriyvyatkin/ra-hw-1-3-calendar)

[Ссылка на Github Pages](https://yuriyvyatkin.github.io/ra-hw-1.3-calendar/)
